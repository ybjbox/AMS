...
export default async function applyTemplate(worksheet, data, config) {
  ...
  return (
    <div className="h-full overflow-y-auto p-6 animate-in fade-in duration-300">
      ...
      {editingScript ? (
        <div className="bg-white dark:bg-zinc-800 rounded-xl border border-blue-200 dark:border-blue-900 shadow-md overflow-hidden animate-in zoom-in-95 duration-200">
